@extends('layouts.appelecteur', ['activePage' => 'profile', 'titlePage' => __('Profil')])
          ...
          <form method="post" action="{{ route('profile.update') }}" autocomplete="off" class="form-horizontal">
            ...
            <div class="card ">
              <div class="card-header card-header-primary">
                <h4 class="card-title">{{ __('Modification du Profil') }}</h4>
                <p class="card-category">{{ __('Information Utilisateur') }}</p>
              </div>
              <div class="card-body ">
                @if (session('status'))
                  <div class="row">
      ...
      <div class="row">
        <div class="col-md-12">
          <form method="post" action="{{ route('profile.password') }}" class="form-horizontal">
            ...
            <div class="card ">
              <div class="card-header card-header-primary">
                <h4 class="card-title">{{ __('Changement du mot de passe') }}</h4>
              ...
              <div class="card-body ">
                ...
                @endif
                <div class="row">
                  <label class="col-sm-2 col-form-label" for="input-current-password">{{ __('Ancien mot de passe') }}</label>
                  <div class="col-sm-7">
